...
import coda.thecrabshack.client.model.DuckyMaskModel;
...
public class DuckyMaskArmorItem extends ArmorItem {
    // TODO change the repair item
    public static final IArmorMaterial MATERIAL = new TCSArmorMaterial(TheCrabShack.MOD_ID + ":ducky",  4, new int[]{1, 2, 3, 1}, 12, SoundEvents.ARMOR_EQUIP_TURTLE, 0.0F, () -> Ingredient.of(Items.IRON_INGOT));
    ...
    public DuckyMaskArmorItem(EquipmentSlotType slot) {
        super(MATERIAL, slot, new Properties().tab(TCSItems.GROUP));
    }
