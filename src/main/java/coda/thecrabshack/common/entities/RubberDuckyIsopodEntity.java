...
public class RubberDuckyIsopodEntity extends CreatureEntity {
    ...
    protected ActionResultType mobInteract(PlayerEntity player, Hand hand) {
        ...
        if (item == TCSItems.BARK.get()) {
            if (random.nextFloat() > 0.9F) {
                ItemEntity molt = EntityType.ITEM.create(world);
                molt.setItem(new ItemStack(TCSItems.RUBBER_DUCKY_ISOPOD_MOLT.get()));
            ...
            world.addParticle(new ItemParticleData(ParticleTypes.ITEM,  new ItemStack(TCSItems.BARK.get())), d0, d1, d2, vector3d.x, vector3d.y + 0.05D, vector3d.z);
    ...
    public static boolean checkIsopodSpawnRules(EntityType<? extends CreatureEntity> p_223316_0_, IWorld p_223316_1_, SpawnReason p_223316_2_, BlockPos p_223316_3_, Random p_223316_4_) {
        return p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.GRASS) && p_223316_1_.getLightEmission(p_223316_3_) < 8 && p_223316_1_.getHeight() < 54;
    }
}
